...
public class EatingTracker extends Tracker
{
    ...
    public void doProcess()	{
        ...
        for (int c = 0; c < 2; ++c)	{
            ...
            Vec3 controllerPos = convertToVec3(dh.vr.controllerHistory[c].averagePosition(0.333D, new Vector3d())).add(vrplayer.vrdata_room_pre.getController(c).getCustomVector(new Vec3(0.0D, 0.0D, -0.1D)));
